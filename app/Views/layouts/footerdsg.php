        ...
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-brand">
                    <div class="logo">
                        <div class="logo-icon">
                            <img src="<?= base_url('images/logo_3.1.png')?>" style="border-radius: 20px;" alt="DSG PERU TECHNOLOGY">
                        </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-social">
                    <a href="https://www.facebook.com/dsgperu/?locale=es_LA" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
                    <a href="https://www.tiktok.com/@dsg.peru.technolo" aria-label="Tiktok"><i class="fa-brands fa-tiktok"></i></a>
                    <a href="https://www.instagram.com/dsgperu?igsh=NHczY3l2dDdiNWZj" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </footer>